...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav text-inline my-2 my-lg-0">
      <% if (user != null) { %>
      <li class="nav-item">
        <a class="nav-link" href="./profile.jsp">Bem-vindo de volta, <%=user.getNome()%>!</a>
      </li>
      <li class="nav-item">
      ...
      <%} else {%>
      <li class="nav-item">
        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#loginModal">Conecte-se<i class="fas fa-sign-in-alt"></i></button>
      </li>
      <%}%>
    </ul>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="loginModalLabel"><i class="fas fa-sign-in-alt"></i> Conecte-se</h5>
      ...
      <div class="modal-body">
        ...
        <form action="login" method="post" name="loginForm">
          <div class="form-group">
            <label for="loginEmail">Endereco de email</label>
            <input type="email" class="form-control" id="loginEmail" name="userEmail" aria-describedby="emailhHelp" placeholder="Email" required>
          </div>
          <div class="form-group">
            <label for="loginPsw">Senha</label>
            <input type="password" class="form-control" id="loginPsw" name="userPassword" aria-describedby="pswHelp" placeholder="Senha" required>
          </div>
          <div class="row">
        ...
        <hr>
        <small><a href="./register.jsp">Novo usuario? Clique aqui para se inscrever!<i class="fas fa-user-plus"></i></a></small>
      </div>
    </div>
  </div>
</div>
